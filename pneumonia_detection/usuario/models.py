...
class Informe(models.Model):
    inicio_enfermedad = models.DateField()
    caracterizado = models.TextField()
    examenes = models.TextField()
    antecedentes_importancia = models.CharField(max_length=255, )
    frecuencia_cardiaca = models.IntegerField()
    frecuencia_respiratoria = models.IntegerField()
    tension_arterial = models.IntegerField()
    saturacion_oxigeno = models.IntegerField()
    recomendacion = models.TextField(max_length=255, )
